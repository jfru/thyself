...
CREATE TABLE IF NOT EXISTS person_identities (
    ...
    description TEXT,                    -- brief note: who they are, how they relate to the subject
    contact_id INTEGER REFERENCES contacts(id),
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS corrections (
    ...
    target TEXT,                         -- what's being corrected, e.g. "relationship_arcs.Jane Doe", "person_portrait.character_summary"
